  ...
  return (
    <>
      <div className="w-full snap-y min-h-screen overflow-y-scroll">
        <div className="bg-main-bg bg-no-repeat bg-cover h-screen w-full px-2 min-[375px]:px-5 snap-start relative" style={{ backgroundImage: 'url("/img/webred.png")' }}>
          <div className="flex flex-col items-center text-center h-50 wrapper pt-10 gap-20">
            ...
            <div className="h-[50vh] flex flex-col gap-5 justify-center">
              ...
              <div>
                ...
                <div className="flex flex-col text-white font-gotham gap-2"style={{ backgroundImage: 'url("/img/webred.png")' }}>
